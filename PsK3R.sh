...
echo $me"       *Y888888888888888       PSK3R NJ0H0 80         *Y88888888888888P="
...
echo $pur"|         Tools BY:PSK3R / Mr.PsK3R.         |"
echo $pur"|       Channel Youtube:Yt-Anang F        |"
echo $cy"|           Facebook:No Name           |"
echo $cy"|             instagram:Mr.PsK3R               |"
echo $ku"|      Jangan Lupa Subscribe Channel saya      |"
echo $cy"################################################"
...
echo $me"21."$e"DEFACE TEBAS INDEX  "
echo $me"22."$e"DEFACE TEBAS INDEX2 BERTARGET (BELOM JADI) "
echo $me"23."$e"10 DDoS ATTACKER"
echo $me"24."$e"Crazy DOS (Sendiri Ajah)"
echo $me"25."$e"HACK CCTV (MASIH 30%)"
echo $me"26."$e"EXIT/KELUAR PROGRAMS"
echo
echo $i  "╭──{PILIH-NOMER}─"$ku"[R13F]"
read -p " ╰─> " pil
...
then
clear
echo $me"DIBILANGIN BELOM JADI NGEYEL :V "
sleep 4
echo $i"KEMBAIL KE PROGRAM"
sleep 4
sh BG71.sh
fi
...
clear
figlet -f slant "W A I T"|lolcat
git clone https://github.com/R133F/10Attacker
cd 10Attacker
sh attack.sh
fi
...
figlet -f slant "W A I T" | lolcat
sleep 1
git clone https://github.com/R133F/Crazydos
cd Crazydos
sh crazydos.sh
fi
...
sleep 2
echo $ku"WhatsApp :"$i" +18313184579"
echo $ku"Facebook :"$i" No Name"
sleep 2
